...
globalkeys = awful.util.table.join(
    ...
    -- Layout manipulation
    awful.key({ modkey, "Shift"   }, "j", function () awful.client.swap.byidx(  5)    end),
    awful.key({ modkey, "Shift"   }, "k", function () awful.client.swap.byidx( -5)    end),
    awful.key({ modkey, "Control" }, "j", function () awful.screen.focus_relative( 5) end),
    awful.key({ modkey, "Control" }, "k", function () awful.screen.focus_relative(-5) end),
    ...
    awful.key({ modkey,           }, "l",     function () awful.tag.incmwfact( 2)    end),
    awful.key({ modkey,           }, "h",     function () awful.tag.incmwfact(-2)    end),
    awful.key({ modkey, "Shift"   }, "h",     function () awful.tag.incnmaster( 5)      end),
    awful.key({ modkey, "Shift"   }, "l",     function () awful.tag.incnmaster(-5)      end),
    awful.key({ modkey, "Control" }, "h",     function () awful.tag.incncol( 5)         end),
    awful.key({ modkey, "Control" }, "l",     function () awful.tag.incncol(-5)         end),
