...
#	alias jump1='ssh -qTfnN -D 9999 -p 22 jslognet@r.jslog.net'
	alias jump1='ssh -fN -D 9999 -p 22 root@alindou.com'
	alias jumpp='ssh -f -N -D 9999 -R 8888:localhost:22 root@alindou.com'
...
alias mvnit='mvng resources:testResources compiler:testCompile install -Dmaven.test.skip=true'
